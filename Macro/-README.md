...
#
#          - Macro Calibrate PA : La macro définit les paramètres de la bande, tels que les valeurs de pression de départ et les incréments de pression, le nombre de bandes 
#                                 à imprimer,
#                                 le nombre de lignes par bande et la vitesse d'impression. Ensuite, elle calcule les dimensions de la bande, la largeur des lignes et
#                                  des espaces,
